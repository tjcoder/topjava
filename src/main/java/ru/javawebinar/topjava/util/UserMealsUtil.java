...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExceed> getWithExceed(List<UserMeal> userMeals, int caloriesPerDay)
    {
        return getFilteredMealsWithExceededByCycle(userMeals, LocalTime.MIN, LocalTime.MAX, caloriesPerDay);
    }
}